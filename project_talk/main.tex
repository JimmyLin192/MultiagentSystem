...
\item Objectives: 
    \begin{itemize}
        ...
        \item make as fewer collision as possible
    \end{itemize}
    \end{itemize}
}
...
\item This can be formulated as an integer programming problem. 
...
\frame{
    ...
    \begin{itemize}
        \item Relax the "Centrailization" assumption and yield a decentralized system
    with
    \begin{itemize}
    ...
    \item  We need 
    \begin{itemize}
        \item Local Optimizers that approximates the global optimizers 
        \item A collision-free protocol between agents
    \end{itemize}
