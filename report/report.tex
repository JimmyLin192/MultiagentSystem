...
domestic service provider. Reinforcement learning...
In this paper, we investigate how the multiagent coordination could improve
the working efficacy of Roomba in the task of cleaning the floor.

% Decentralized system
The decentralized decision making has a long history, originated from the team
thoery (\hspace*{-0.8mm} \cite{marschak1955elements}, \cite{radner1962team}),
...
autonomous agents.  Previous works for the coordinating mechanisms include
