...
planning can be formulated as optimization problems, and how the coordinative
behaviors can be figured out by the reinforcement learning technique and the
...
\section{Experiments} \label{section:realexpo}
