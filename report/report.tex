...
reset to their original settings once one episode expires. 
Except the spatial positions of agents, all other properties are allowed to
preserve through two adjacent episodes. 
This enables a simpler process of learning. 
For example, the accumulated Q-knowledge from previous episodes. 
Note that the default configuration for one episode is 100 steps. 
That is, all agents will be placed back to their birth places after 100 steps
no matter how many pellets they have collected. And . 
