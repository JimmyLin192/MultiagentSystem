...
\title{Multiagent Coordination in the Roomba: From the Perspectives of
...
behaviors we expected to see in the following experiments.  
\textbf{TODO: Our approach..}
The experiments that demonstrate our attempts and achievements on multiagent
coordination are articulated in the section \ref{section:realexpo}.  
We summarize our conclusions and discuss some promising future
works in the section \ref{conclusion}. 
...
where a dynamic DCOP is a sequence of static DCOPs, each of which is partially
...
(DCOP) \cite{maheswaran2004taking}, ADOPT \cite{modi2005adopt}, and Support-Based Distributed
...
% Communication vs stigmegy (simple) \cite{yong2001cooperative}
...
\section{Reinforcement Learning Experiments} \label{section:realexpo}
...
In the following experiments, agents were controlled by neural networks trained using NeuroEvolution of Augmenting Topologies (NEAT).
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.0in, height=2.0in]{./figures/neroevolution/emerg_comm_results.png}
