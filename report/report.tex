...
\caption{Q-learning with various simple sensors. (i) Red: G-random curve
    ...
    (ii) (iii) (iv) agents receive various sensors for the decision making of
    each step.
} 
\label{fig:RL_init}
\end{figure}
...
The sensors designed for this experiment are as follows. 
\begin{equation}
    S_{default} = \left( \begin{array}{c}
      bump \\     
      position.x \\
      position.y \\
      closest.x \\
...
The results of the first experiments are indicated in the Fig. \ref{fig:RL_init}. 

From the Fig. \ref{fig:RL_init}, it is observed that .
