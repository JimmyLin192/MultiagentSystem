...
Real-time NEAT does not use generations. However, the search space is eventually depleted of crumbs and must be reset. This is achieved through \it{episode} which last a fixed interval and begin by distributing agents and crumbs around the environment. Agents' brains are continually swapped out durring an episode according to the rtNEAT algorithm.
