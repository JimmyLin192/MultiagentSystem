...
\section{Problem Formulation} \label{section:environment}
...
\subsection{Our Approach: Reinforcement Learning} 

\subsection{Our Approach: Neuroevolution} 
...
After testing the initial setup of each technique under the Roombas
environment, we intend to investigate the problem of how to incorporate
effective coordinations for this particular multiagent system.
\subsection{Reinforcement Learning}

% preliminary results
Before diving into the investigation of multiagent coordination, we present
some preliminary results with regard to the impact of various simple sensors
on the Q-learning outcome.

\begin{figure}[t]
\centering
\includegraphics[width=3.0in]{./figures/RL/inisetup.eps}
\caption{Preliminary experiments of the Q-learning with various sensors}
\label{fig:RL_init}
\end{figure}
