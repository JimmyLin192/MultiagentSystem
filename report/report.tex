...
have been proposed to solve relevant practical problems
\cite{banerjee2012sample, kraemer2012informed}. 

%######################################################################
% ND-POMDP and algorithm
\cite{nair2005networked}.

One model-free, scalable learning approach that synthesizes multiagent
reinforcement learning and distributed constraint optimization (DCOP) was
illustrated in \cite{zhang2011coordinated}. This method found globally optimal
policy under the groupwise observability.
