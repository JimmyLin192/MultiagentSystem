...
\frame{
    ...
    \begin{itemize}
        \item Most of works so far (i.e. reinforcement learning,
            neuroevolution) focused exclusively on single agents we can extend
            reinforcement learning straightforwardly to multiple agents if
        ...
        \item Today, we will touch a broad area 
...
\frame{
    ...
    Currently active research areas of M.A.S. are as follows:
    \begin{itemize}
        \item {\bf Communication}%: how to share information between agents
        \item Cooperation and Coordination
            %: given shared information, how does
           % each individual agent make decisions 
        \item Negotiation%: what if decisions are in conflict to one another?
        \item Distributed Problem Solving
            %: how to simplify the large state
            %space by providing smaller set of actions for the problem domian?
        ...
        \item {\bf Multi-agent Learning}%: Social Learning
        \item Fault Tolerance%: how M.A.S. responds to the failure of some agents?
    \end{itemize}
}
% communication
...
\frame{
    ...
    information from it.
    \begin{itemize}
        \item Direct Communication: share information with one another in
            explicit way.
        \item Indirect Communication: implicit transfer of information from agent to
agent through modification of the world environment.
    \end{itemize}
}
...
\frame{
    ...
    Even with communication, homogeneous networks do poorly, catching the prey only 3\% of the time
}
...
\frame{
    ...
    \begin{itemize}
        \item Motivations: Multiagent Learning
            \begin{itemize} 
                \item Faster Convergence
                \item Flexible Architectures
                \item Collectively Robust
            \end{itemize}
        \item Where to start?
            \begin{itemize}
                \item Begin from implementing ESP for Roombas in Opennero
                    Platform
            \end{itemize}
        \item Suggestions?
        \end{itemize}
