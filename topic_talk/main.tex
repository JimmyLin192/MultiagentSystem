...
\frame{
    \frametitle{Multiagent behaviors in Neural Network}
    \begin{itemize}
...
\frame{
    ...
    \begin{columns}[T] 
             ...
             \begin{itemize}
                 ...
                 \item \textbf{Problem}: How to decide which agents should be teachers and which student?
                 \end{itemize}
             \end{column}
             \begin{column}[T]{4cm} 
...
\frame{
    ...
    \begin{columns}[T] 
    	\begin{column}[T]{5cm} 
		    \begin{itemize}
		    \item Agents trained via Reinforcement Learning
...
\frame{
    ...
    \item Use backpropagation networks and train with NeuroEvolution of Augmenting Topologies (NEAT)
    \end{itemize}
}
